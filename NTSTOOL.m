...
% Created 17-Oct-2022 19:29:53
%
% This script assumes these variables are defined:
%
%   summer1 - input time series.
%   summer2 - feedback time series.

X = tonndata(summer1,false,false);
T = tonndata(summer2,false,false);
...
MAE=mae(e)
MSE=mse(net,t,y)
MAPE= mean((abs(cell2mat(y)-cell2mat(t)))./cell2mat(t))*100
% View the Network
view(net)
